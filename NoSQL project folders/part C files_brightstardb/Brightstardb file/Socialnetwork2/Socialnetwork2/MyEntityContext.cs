...
namespace Socialnetwork2 
{
    public partial class MyEntityContext : BrightstarEntityContext {
        ...
        public static void InitializeEntityMappingStore()
        {
    		...
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(Socialnetwork2.Iuser));
    		EntityMappingStore.Instance.SetImplMapping<Socialnetwork2.Iuser, Socialnetwork2.user>();
    	}
    	...
    	{
    		users = 	new BrightstarEntitySet<Socialnetwork2.Iuser>(this);
    	}
    	
    	public IEntitySet<Socialnetwork2.Iuser> users
    	{
    		get; private set;
    	}
        ...
        public IEntitySet<T> EntitySet<T>() where T : class {
            ...
            if (typeof(T).Equals(typeof(Socialnetwork2.Iuser))) {
...
namespace Socialnetwork2 
{
    ...
    public partial class user : BrightstarEntityObject, Iuser 
    {
    	...
    	#region Implementation of Socialnetwork2.Iuser
    	...
    	{
            		get { return GetRelatedProperty<System.String>("hobby"); }
            		set { SetRelatedProperty("hobby", value); }
    	}
    
    	public System.String occupation
    	{
            		get { return GetRelatedProperty<System.String>("occupation"); }
            		set { SetRelatedProperty("occupation", value); }
    	}
    	public System.Collections.Generic.ICollection<Socialnetwork2.Iuser> friend
    	{
    		get { return GetRelatedObjects<Socialnetwork2.Iuser>("friend"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedObjects("friend", value); }
    								}
    	public System.Collections.Generic.ICollection<Socialnetwork2.Iuser> friends
    	{
    		get { return GetRelatedObjects<Socialnetwork2.Iuser>("friends"); }
